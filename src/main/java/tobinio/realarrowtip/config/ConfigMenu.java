...
public class ConfigMenu implements ModMenuApi {
    ...
    public ConfigScreenFactory<?> getModConfigScreenFactory() {
        return parentScreen -> YetAnotherConfigLib.create(Config.HANDLER,
                (defaults, config, builder) -> builder.title(Component.translatable("real-arrow-tip.config.title"))
                        .category(ConfigCategory.createBuilder()
                                .name(Component.translatable("real-arrow-tip.config.category-title"))
                                .tooltip(Component.literal("All the settings"))
                                .option(Option.<Boolean>createBuilder()
                                        .name(Component.translatable("real-arrow-tip.config.render-custom-arrow-entity.name"))
                                ...
                                .option(ListOption.<String>createBuilder()
                                        .name(Component.translatable("real-arrow-tip.config.config.ignored-items.name"))
                                        .description(OptionDescription.of(Component.translatable(
